...
models = {
    "beetle", "bora", "cc", "corrado", "eos", "fox", "golf", "jetta",
    "karmann ghia", "lupo", "passat", "phaeton", "polo", "scirocco",
    "sharan", "t-cross", "t-roc", "tiguan", "touareg", "touran",
    "up", "vento"
}
...
def fetch_olx_data(max_pages=38):  # Ensuring max_pages is the same for consistency
